<?php
/*
 * Walker Comment の拡張クラス
 */
class Ft_Walker_Comment extends Walker_Comment {
...
?>
		...
		<?php
			add_filter('comment_text', array( $this, 'custom_comment_text' ));
			comment_text( $comment, array_merge( $args, array( 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) );
			remove_filter('comment_text', array( $this, 'custom_comment_text' ));
		?>
...
<?php
	...
	public function custom_comment_text( $html ) {
		return '<div class="comment-text">' . $html . '</div>';
	}
}
