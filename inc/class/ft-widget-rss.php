...
class Ft_Widget_RSS extends WP_Widget_RSS {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title )
			...
			$title = '<a class="rsswidget-icon" href="' . esc_url( $url ) . '"><i class="fa fa-rss-square" aria-hidden="true"></i></a><a class="rsswidget" href="' . esc_url( $link ) . '">'. esc_html( $title ) . '</a>';
	 ...
	 */
	private function widget_rss_output( $rss, $args = array() ) {
		if ( is_string( $rss ) ) {
			$rss = fetch_feed($rss);
